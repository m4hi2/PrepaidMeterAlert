...
type Meter struct {
	...
	LastReadingAt          *time.Time   `bun:"last_reading_at,nullzero"`
	...
	StaleNotificationStatus NStatus     `bun:"stale_notification_status,notnull,type:varchar(10),default:'not_needed'"`
}
